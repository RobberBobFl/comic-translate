...
class WorkspaceMixin:
    def _create_main_content(self):
        ...
        t_combo_row = QtWidgets.QHBoxLayout()
        ...
        t_combo_row.addWidget(self.t_combo, 1)
        self.rephrase_button = QtWidgets.QPushButton("\U0001F504")
        self.rephrase_button.setFixedSize(32, 32)
        self.rephrase_button.setToolTip(self.tr("Rephrase the selected block's translation"))
        self.rephrase_button.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        t_combo_row.addWidget(self.rephrase_button, 0, QtCore.Qt.AlignmentFlag.AlignTop)
        t_combo_text_layout.addLayout(t_combo_row)
