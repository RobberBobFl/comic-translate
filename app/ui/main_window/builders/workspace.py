...
class WorkspaceMixin:
    def _create_main_content(self):
        ...
        t_text_row = QtWidgets.QHBoxLayout()
        self.t_text_edit = MTextEdit()
        self.t_text_edit.setFixedHeight(120)
        t_text_row.addWidget(self.t_text_edit, 1)
        ...
        t_text_row.addWidget(self.rephrase_button, 0, QtCore.Qt.AlignmentFlag.AlignTop)
        t_combo_text_layout.addLayout(t_text_row)
